  ...
  template: `
    ...
    >
      @switch (name()) {
        ...
        @case ('star') {
          <path
            d="M8 1.5l1.9 3.9 4.3.6-3.1 3 .7 4.2L8 11.2 4.2 13.2l.7-4.2-3.1-3 4.3-.6z"
          />
        }
        @case ('fork') {
        ...
        @case ('location') {
          <path d="M8 1.5c2.5 0 4.5 2 4.5 4.5C12.5 9.5 8 14.5 8 14.5S3.5 9.5 3.5 6C3.5 3.5 5.5 1.5 8 1.5z" />
          <circle cx="8" cy="6" r="1.6" />
        }
        @case ('link') {
          <path d="M6.5 9.5l3-3M5.5 7.5L4 9a2.1 2.1 0 003 3l1.5-1.5M10.5 8.5L12 7a2.1 2.1 0 00-3-3L7.5 5.5" />
        }
        @case ('building') {
        ...
        @case ('external') {
          <path d="M9 2.5h4.5V7M13.5 2.5L7.5 8.5M11.5 9v3.5A1 1 0 0110.5 13.5h-7A1 1 0 012.5 12.5v-7A1 1 0 013.5 4.5H7" />
        }
        @case ('close') {
        ...
        @case ('twitter') {
          <path d="M14 4.3a5 5 0 01-1.4.4A2.5 2.5 0 0013.7 3a5 5 0 01-1.6.6A2.5 2.5 0 007.8 5.8 7 7 0 012.7 3.2a2.5 2.5 0 00.8 3.3 2.4 2.4 0 01-1.1-.3 2.5 2.5 0 002 2.5 2.5 2.5 0 01-1.1 0 2.5 2.5 0 002.3 1.7A5 5 0 012 11.4a7 7 0 003.8 1.1c4.6 0 7.1-3.8 7.1-7.1v-.3A5 5 0 0014 4.3z" />
        }
        @case ('archive') {
        ...
        @case ('trash') {
          <path d="M2.5 4h11M5.5 4V2.5h5V4M4 4l.5 9a1 1 0 001 1h5a1 1 0 001-1L12 4M6.5 6.5v5M9.5 6.5v5" />
        }
      }
    </svg>
  `,
